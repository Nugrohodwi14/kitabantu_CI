...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Kita Bantu</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="<?php echo base_url()."index.php/depan/login"; ?>" style="color: orangered;">
              Login
            </a>
          </li>
        </ul>
  ...
  <header class="masthead">
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">come join us now !!!!</div>
        <div class="intro-heading text-uppercase">KITA BANTU!!</div>
        <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#services">Yuk Cari Tahu</a>
      </div>
    </div>
  </header>
    ...
    <div class="container">
      ...
      <div class="row text-center">
        <div class="col-md-4">
          ...
          <h4 class="service-heading">Acara Terpecaya</h4>
          <p class="text-muted">
        ...
        <div class="col-md-4">
          ...
          <h4 class="service-heading">Informasi 24 jam</h4>
          <p class="text-muted">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima
            maxime quam architecto quo inventore harum ex magni, dicta
            impedit.
        ...
        <div class="col-md-4">
          ...
          <h4 class="service-heading">Mudah Membantu</h4>
          <p class="text-muted">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima
            maxime quam architecto quo inventore harum ex magni, dicta
            impedit.
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
            ...
            <img class="img-fluid" src="<?php echo base_url()."assets/"; ?>img/portfolio/apss.jpg" alt="" />
          </a>
          <div class="portfolio-caption">
            <h4>Bantu Developing Apps</h4>
        ...
        <div class="col-md-4 col-sm-6 portfolio-item">
          ...
          <div class="portfolio-caption">
            <h4>Bantu Penyemprotan Disinfektan di Kota Semarang</h4>
            <p class="text-muted">semarang</p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
          ...
          <ul class="timeline">
            <li>
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>25 Maret 2020</h4>
                  <h4 class="subheading">Ide kita bantu</h4>
                </div>
            ...
            <li class="timeline-inverted">
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>31 Maret 2020</h4>
                  <h4 class="subheading">Soft launching Apps</h4>
                </div>
                <div class="timeline-body">
                  <p class="text-muted">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
  ...
  <section class="bg-light page-section" id="team">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="<?php echo base_url()."assets/"; ?>img/team/A12.2018.05930.png" alt="" />
            <h4>Nugroho Dwi Yulianto</h4>
        ...
        <div class="col-sm-4">
          <div class="team-member">
            <img class="mx-auto rounded-circle" src="<?php echo base_url()."assets/"; ?>img/team/IMG_8825.JPG" alt="" />
            <h4>Zaidan Al Banna</h4>
  ...
  <section class="page-section" id="contact">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-12">
          <form action="<?php echo base_url()."index.php/depan/proses_daftar_relawan"; ?>" method="POST">
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <input name="username" class="form-control" id="name" type="text" placeholder="username"
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <img class="img-fluid d-block mx-auto" src="<?php echo base_url()."assets/"; ?>img/portfolio/apss.jpg" alt="" />
                <p>
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <img class="img-fluid d-block mx-auto" src="<?php echo base_url()."assets/"; ?>img/portfolio/bersih.jpg" alt="" />
                <p>
                  Use this area to describe your project. Lorem ipsum dolor
                  sit amet, consectetur adipisicing elit. Est blanditiis
                  dolorem culpa incidunt minus dignissimos deserunt repellat
        ...
        $("#email").change(function(){
          ...
          $.ajax({
            ...
            success: function(msg){
              if(msg=='1'){
                $('#result-email').html('<label style="color:#dd4b39;">Maaf email sudah ada, ganti yang lain sana</label>');
              }
              else{
                $('#result-email').html('<label style="color:#00a65a;">Selamat anda berhasil</label>');
              }
            }
          });
        });
