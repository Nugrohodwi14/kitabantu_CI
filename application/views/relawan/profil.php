          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form action="<?php echo base_url()."index.php/dashboardrelawan/proses_edit_profil/".$this->session->userdata('id_relawan');?>" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="text" name="tempat_lahir" value="<?php echo $tempat_lahir;?>" class="form-control"><br><br> 
                            Tanggal Lahir : <br>
                        <input type="text" name="tanggal_lahir" value="<?php echo $tanggal_lahir;?>" class="form-control">Format : YYYY-BB-HH
                         <br><br>
                             Alamat : <br>
                        <textarea name="alamat" class="form-control"><?php echo $alamat;?></textarea><br>
                                No_handphone : <br>
                        <input type="text" name="no_hp" value="<?php echo $no_hp;?>" class="form-control"><br><br>
                                foto: <br><br>
                        <img src="<?php echo base_url().$foto;?>" alt=""><br><br>
